...
plt.errorbar(temperature, pressure, error, linestyle = 'None', marker='o', mfc='orange', mec='r', ms=10, mew=1, ecolor = "k");
...
y2 = slope * -273 + intercept;  # y2 = m(x2) + b
x_range = [-273.15, 150];          # array of x values
